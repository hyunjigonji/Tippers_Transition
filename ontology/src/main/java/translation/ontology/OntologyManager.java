...
public class OntologyManager {
   ...
   public static String ontologyURL = "/Users/hyunjigonji/eclipse-workspace/ontology/ontology.owl";
   ...
   public static IRI ontologyIRI = IRI
         .create("/Users/hyunjigonji/eclipse-workspace/ontology/ontology.owl");
...
//      System.out.println("from: " + ontologyIRI);
   ...
   // findSensor
   // observation을 주면 sensor를 넘겨줌
   public static OWLObjectProperty findSensor() {
      ArrayList<OWLSubPropertyAxiom> results = null;
      ...
      for (final OWLSubObjectPropertyOfAxiom subProp : ontology.getObjectSubPropertyAxiomsForSuperProperty(p)) {
         if (subProp.getSuperProperty() instanceof OWLProperty && subProp.getSubProperty() instanceof OWLProperty) {
            ...
            if (subProp.getSuperProperty().toString().equals(
               ...
               System.out.println(subProp.getSubProperty());
...
//      for (OWLObjectProperty p : ontology.getObjectPropertiesInSignature()) {
//         if (p.getIRI().toString().equals("http://www.semanticweb.org/kimkimin/ontologies/2019/6/untitled-ontology-12#captures")) {
//            System.out.println(reasoner.getObjectPropertyRanges(p));
//            System.out.println(reasoner.getSuperObjectProperties(p));
//         }
//      }
      return null;
   }
